...
def residual(t, SV, pars, ptr, flags):
    ...
    CALCULATE TERMS FOR VOLUMETRIC THERMAL ENERGY PRODUCTION: ANODE (W/m3)
    """
    ...
    Q_cond = -Q_cond_an/pars.H_an #no negative sign because we had it in line 47
    ...
    CALCULATE TERMS FOR VOLUMETRIC THERMAL ENERGY PRODUCTION: ELYTE (W/m3)
    """
